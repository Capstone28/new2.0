...
<div class="container">
  <div class="row">
	<div class="col-sm-4">
        <div class="thumbnail">
          <img src="../img/champion.jpg" alt="John Champion" width="250" height="250">
    ...
    <div class="col-sm-8">
      ...
      <div>
      	<h4>Faculty</h4>
      	<p>Champion, John - Professional musician (went on tour), then TV journalism (KSAT/KBB/WAI Ch4), then Time-Warner (installed Roadrunner), BusinessWire (Project Lead in encrypted news delivery), and Fort Sam Houston 
      	(Project Manager). MS in CIS and BA in Broadcast Journalism. Plays guitar, writes songs, expert photographer. Part-time UIW CIS Faculty member from 2008-2011 and full time since 2012.</p>
      </div>
      <br>
      <div>
